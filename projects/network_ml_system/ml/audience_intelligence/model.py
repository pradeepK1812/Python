...
class SentimentModel(nn.Module):
    ...
    def __init__(self, vocab_size, max_seq_length , embedding_dim):
        ...
        self.num_classes = 6 # as now we have 6 different emotion classes
       ...
       # self.fc = nn.Linear(
        #    embedding_dim,
         #   1
        #)
        #now we have 6 emotion classes so final clasifies should be having them
        self.fc = nn.Linear(
          embedding_dim,
          self.num_classes
        )
        ...
        # Probability output
        # -----------------------------------
        # not needed as now we use CrossEntropyLoss whichinternally applies softmax internally
    ...
    # -----------------------------------
      #not needed now as we use CrossEntropyLoss 
