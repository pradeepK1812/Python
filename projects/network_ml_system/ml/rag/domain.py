...
class GeneratedAnswer:
    """
    Represents the answer generated by the Generator.

    This domain object encapsulates the response returned to the
    application while remaining independent of the underlying LLM
    implementation.
    """
