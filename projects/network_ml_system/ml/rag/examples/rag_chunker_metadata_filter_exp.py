"""
Module: rag_chunker_metadata_filter_exp.py
...
def _find_boundary(
    ...
    boundary = content.rfind(".", 0, target_end)
...
def chunk_by_boundary(
    ...
    for section in document.sections:
        ...
        while start < len(content):
            ...
            #if remaining part is less than min chunk size then do not leave it take it in current chunk only
...
if __name__ == "__main__":
    ...
    chunks = chunk_by_boundary(strDoc,CHUNK_SIZE)
