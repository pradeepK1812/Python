...
class MaskedMultiHeadAttention(nn.Module):
    ...
    # -----------------------------------
      ...
      #
      #------------------------------
      sequence_length = attention_scores.size(-1)

      #torch.once creates matrix of size seq_lenX seq_len filled with all ones 
      #torch.tril changes it into Lower Triangular Matrix
      mask = torch.tril(
        torch.ones(
        sequence_length,
        sequence_length,
      ...
      # Replacing the zeros in matrix with -infinity
